...
// Enqueues templates when a client's status changes (Option B behavior)
 ...
 * OPTION B:
 * - A template can be sent again if the client's status changes back
 * - Prevents duplicates for the same status
 */
